...
public abstract class Hilt_EditUserFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_EditUserFragment() {
    super();
  }

  Hilt_EditUserFragment(int p0) {
    super(p0);
  }
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((EditUserFragment_GeneratedInjector) this.generatedComponent()).injectEditUserFragment(UnsafeCasts.<EditUserFragment>unsafeCast(this));
    }
  }
